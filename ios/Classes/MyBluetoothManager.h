...
+ (instancetype)shared;
/// 开始扫描
- (void)startScan:(NSString * _Nullable)deviceName deviceId:(NSString * _Nullable)deviceId timeout:(int)timeout callback:(FlutterReply _Nonnull)callback serviceId:(NSString * _Nullable)serviceId;
/// 结束扫描，获取扫描结果
