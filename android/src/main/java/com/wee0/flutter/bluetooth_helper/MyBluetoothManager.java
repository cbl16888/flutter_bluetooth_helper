...
//        activity.startActivityForResult(enableBtIntent, 1);
     ...
     * 开始扫描
     */
    public void startScan(String deviceName, String deviceAddress, int scanTimeout, final IReply reply, final String serviceId) {
        ...
        this._leScanner.startScan(deviceName, deviceAddress, scanTimeout, reply, serviceId);
    }
